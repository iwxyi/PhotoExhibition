<template>
  <section class="glass-panel p-5 space-y-4 admin-theme-settings-panel">
    <div class="flex items-center justify-end gap-2 text-xs admin-theme-settings-status">
    ...
    <div class="space-y-4 admin-theme-settings-layout">
      <div class="admin-soft-surface rounded-[28px] border p-4 space-y-3.5 admin-theme-style-block">
        <div class="text-sm text-[color:var(--pe-admin-text-primary)]">设计风格</div>
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-3 admin-theme-style-grid">
          <button
          ...
          >
            <div class="admin-style-card-preview" :data-style="key">
              ...
              <div class="admin-style-card-preview-accent"></div>
              <div class="admin-style-card-preview-label">{{ def.name }}</div>
              <div v-if="key === themeStore.currentStyleFamily" class="admin-style-card-current">当前</div>
            </div>
            ...
            <div class="mt-2 text-xs leading-5 text-[color:var(--pe-admin-text-muted)]">{{ def.description }}</div>
          </button>
        </div>
      </div>

      <div class="space-y-4 admin-theme-gallery-stage">
        <div class="admin-soft-surface rounded-[28px] border p-4 space-y-3 admin-theme-mode-block">
          <div class="flex items-center justify-between gap-3 flex-wrap">
            <div class="text-sm text-[color:var(--pe-admin-text-primary)]">显示模式</div>
            <div class="text-xs text-[color:var(--pe-admin-text-muted)]">浅色与深色</div>
          </div>
          <div class="admin-theme-mode-stack">
            <button
              type="button"
              @click="handleSetColorMode(false)"
              class="flex w-full items-center justify-between rounded-[22px] border px-4 py-3 text-left transition-all duration-200 admin-theme-mode-option"
            ...
            >
              <div class="space-y-1">
                ...
                <div class="text-xs text-[color:var(--pe-admin-text-muted)]">通透明快</div>
              </div>
            ...
            >
              <div class="space-y-1">
                ...
                <div class="text-xs text-[color:var(--pe-admin-text-muted)]">沉浸高对比</div>
              </div>
        ...
        <div class="space-y-5">
          <section v-if="currentThemeEntry" class="theme-gallery-spotlight">
            <div class="theme-gallery-spotlight-preview" :style="previewStyle(currentThemeEntry[0])" :data-style="themeStore.currentStyleFamily">
              ...
              <div class="theme-gallery-preview-style-mark">{{ currentStyleFamilyName }}</div>
            </div>
              ...
              <div class="flex items-start justify-between gap-4 flex-wrap">
                <div class="space-y-2">
                  <div class="flex items-center gap-3 flex-wrap">
                    ...
                    <span class="theme-gallery-chip">当前</span>
                  </div>
          ...
          >
            ...
            <div class="theme-gallery-card-grid">
              ...
              >
                <div class="theme-gallery-preview" :style="previewStyle(key)" :data-style="themeStore.currentStyleFamily">
                  <div class="theme-gallery-browser">
                    <div class="theme-gallery-browser-bar">
                      <div class="flex gap-2">
                        <span class="h-2.5 w-2.5 rounded-full bg-white/85"></span>
                ...
                <div class="theme-gallery-meta">
                  <div class="min-w-0 flex-1">
                    ...
                    <div class="theme-gallery-meta-divider"></div>
