...
public class DerivePersonPairCooccurrenceOperator implements AiSearchOperator {
    ...
    public String getName() {
        return "derive_person_pair_cooccurrence";
    }
    ...
    public Object execute(AiSearchPlanStep step, AiSearchExecutionContext context) {
        ...
        for (Object[] row : faceRepository.summarizePersonPairCooccurrencesByPhotoIds(photoIds)) {
