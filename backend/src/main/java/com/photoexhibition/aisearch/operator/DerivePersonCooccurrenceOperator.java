...
public class DerivePersonCooccurrenceOperator implements AiSearchOperator {
    ...
    public String getName() {
        return "derive_person_cooccurrence";
    }
    ...
    public Object execute(AiSearchPlanStep step, AiSearchExecutionContext context) {
        ...
        for (Object[] row : faceRepository.summarizePersonCooccurrencesByPhotoIds(anchorPersonId, photoIds)) {
